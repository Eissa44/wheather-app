...
// search btn get input value and send the value to getdata func 
...
function display(myobj){
   ...
   >
     <div>
       ...
       >
         ...
         <img src="${myobj?.current?.condition?.icon}" alt="cloude" />
       </div>
 ...
 >
   <div>
     ...
     >
       <img src="${myobj?.forecast.forecastday[1].day.condition.icon}" alt="cloude" class="w-25 py-3" />
            ...
            >
              <div>
                ...
                <div
                  class="degre d-flex flex-column justify-content-between align-items-center"
                >
                <img src="${myobj?.forecast.forecastday[2].day.condition.icon}" alt="cloude" class="w-25 py-3" />
